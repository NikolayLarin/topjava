Java Enterprise application "Calories Management" 
===============================
...
## [Описание и план проекта](description.md)
### <a href="http://caloriesbylarin.herokuapp.com/" target=_blank>Демо разрабатываемого приложения</a>
